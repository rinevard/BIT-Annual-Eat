...
const ACH_CONFIG = [
    ...
    { id: "pi", name: "PI", rarity: 3, condition: "单笔消费金额恰为 3.14 元" },
    ...
    { id: "hello_world", name: "Hello World", rarity: 1, condition: "本年有消费过" },
    { id: "story_start", name: "故事的开始", rarity: 4, condition: "在本年第一天吃饭" },
    { id: "another_year", name: "又一年", rarity: 4, condition: "在本年最后一天吃饭" },
    ...
    { id: "error_404", name: "Error 404", rarity: 4, condition: "单笔消费金额恰为 4.04 元" },
