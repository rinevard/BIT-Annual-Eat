...
const ACH_CONFIG = [
    ...
    { id: "pi", name: "PI", rarity: 3, condition: "单笔消费金额恰为 3.14/31.4/314 元", desc: "圆食，启动！", time: "2025-03-14" },
    ...
    { id: "hello_world", name: "Hello World", rarity: 1, condition: "在这一年消费过", desc: "你好，食堂！", time: "2025-01-02" },
    { id: "story_start", name: "故事的开始", rarity: 4, condition: "在第一天吃饭", desc: "其实味道和去年没区别", time: "2025-01-01" },
    { id: "another_year", name: "又一年", rarity: 4, condition: "在最后一天吃饭", desc: "明年见", time: "2025-12-31" },
    ...
    { id: "error_404", name: "Error 404", rarity: 4, condition: "单笔消费金额恰为 4.04/40.4/404 元", desc: "404 Not Found", time: "2025-04-04" },
    { id: "secure_call", name: "加密通话", rarity: 4, condition: "密码不是默认值 123456", desc: "你的账户安全系数击败了99％的同学", time: "2025-01-15" },
